...
def evaluate(respth='./res/test_res', dspth='./data', cp='model_final_diss.pth'):
    ...
    #python inference.py --data /home/wsy/difareli_code/preprocess_scripts/Relighting_preprocessing_tools/test_images/aligned_images/back --output_path ./face_segment/
    import tqdm
    #test_loader = DataLoader(FFHQlmdb(data='/home/lcx/difareli_code/data/ffhq_256_with_anno'), batch_size=1, shuffle=False)
    with torch.no_grad():
