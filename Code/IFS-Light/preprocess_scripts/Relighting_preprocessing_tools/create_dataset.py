...
parser.add_argument('--skintone', action='store_true', default=False)
parser.add_argument('--faceseg', action='store_true', default=False)
parser.add_argument('--albedo', action='store_true', default=False)
#parser.add_argument('--trust', action='store_true', default=False)
...
if __name__ == '__main__':
    ...
    if args.ffhq_align:
        ...
        env =  "/home/user/anaconda3/envs/difa/bin/python"
    ...
    if args.skintone:
        #NOTE: Running Skin tone scale on 
        '''
        python test.py --image_dir ../../ITW/itw_images --out_dir ../../ITW/params/valid/
        '''
        print(sep_str)
        print("[#] Creating the Skin Tone Scale...")
        print(f"[#] From directory : {args.image_dir}")
        env =  "/home/user/anaconda3/envs/difa/bin/python"
        subprocess.call([env, './skintone/test/test-wild.py', 
    ...
    if args.albedo:
        ...
        subprocess.call([env, './estimate_deca_for_dpm.py',
                        ...
                        '--save_albedo_folder', f'{args.out_dataset_dir}/albedo_images/albedo_masked_face_images',
                        '--set', args.set,
                        '--params_prefix', args.set,
                        '--skin_params', f'{args.out_dataset_dir}/params/{args.set}',
