...
# Interpolation
parser.add_argument('--itp', nargs='+', default='shadow') # Do not change this!
...
from difareli_code.guided_diffusion.dataloader.img_deca_datasets import load_data_img_deca
