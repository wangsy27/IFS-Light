...
def load_flame_mask(part='face'):
    ...
    f_mask = np.load("/home/wsy/difareli_code/experimental/masking_flame/FLAME_masks_face-id.pkl", allow_pickle=True, encoding='latin1')
    v_mask = np.load('/home/wsy/difareli_code/experimental/masking_flame/FLAME_masks.pkl', allow_pickle=True, encoding='latin1')
    mask={
...
def init_deca(useTex=False, extractTex=True, device='cuda', 
    ...
    sys.path.insert(1, '/home/wsy/guided-diffusion/sample_scripts/cond_utils/DECA/')
