...
class DECA(nn.Module):
    ...
    def decode(self, codedict, rendering=True, iddict=None, vis_lmk=True, return_vis=True, use_detail=True,
        ...
        if self.cfg.model.use_tex:
            ...
            #albedo = torch.zeros([batch_size, 3, self.uv_size, self.uv_size], device='cuda:0') 
        ...
        if rendering:
            ops = self.render(verts, trans_verts, albedo, h=h, w=w, lights=codedict['light'], background = background)
            ## output
