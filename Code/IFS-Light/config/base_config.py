...
cfg.param_model.params_selector = ['shape', 'pose', 'exp', 'cam', 'light', 'faceemb', 'shadow', 'skincolor']
...
cfg.param_model.albedo = 50
cfg.param_model.skincolor = 1
cfg.param_model.bound = 1.0


#params_dict = {'shape':100, 'pose':6, 'exp':50, 'cam':3, 'light':27, 'faceemb':512, 'shadow':1}
params_dict = {'shape':100, 'pose':6, 'exp':50, 'cam':3, 'light':27, 'faceemb':512, 'shadow':1, 'skincolor':1}
...
img_cond_model_img_type = {'raw':3, 
                            ...
                            'albedo_masked_face_images_wclip':3,
                            'albedo_masked_face_images_woclip':3,
                            'shadow_mask':1,
                            'faceseg_face':3, 
...
cfg.dataset.root_path = '/home/wsy/data'
...
cfg.dataset.deca_rendered_dir = f"{cfg.dataset.root_path}/{cfg.dataset.training_data}/shading_images/"
cfg.dataset.albedo_rendered_dir = f"{cfg.dataset.root_path}/{cfg.dataset.training_data}/albedo_images/"
...
cfg.dataset.shadow_mask_dir = f"{cfg.dataset.root_path}/{cfg.dataset.training_data}/shadow_mask/"
...
cfg.train.logger_dir = "./logs"
cfg.train.logger_mode = "tb"
cfg.train.n_gpus = 1
...
#cfg.diffusion.diffusion_steps = 250
...
def update_dataset_path(cfg):
    ...
    cfg.dataset.albedo_rendered_dir = f"{cfg.dataset.root_path}/{cfg.dataset.training_data}/albedo_images/"
    #cfg.dataset.deca_rendered_dir = f"{cfg.dataset.root_path}/{cfg.dataset.training_data}/shadow_mask/"
    cfg.dataset.laplacian_mask_dir = f"{cfg.dataset.root_path}/{cfg.dataset.training_data}/eyes_segment/"
    cfg.dataset.laplacian_dir = f"{cfg.dataset.root_path}/{cfg.dataset.training_data}/laplacian/"
    cfg.dataset.shadow_mask_dir = f"{cfg.dataset.root_path}/{cfg.dataset.training_data}/shadow_mask/"
    return cfg
