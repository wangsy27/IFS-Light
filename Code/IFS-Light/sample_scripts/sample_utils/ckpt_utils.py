...
class CkptLoader():
    def __init__(self, log_dir, cfg_name, device=None) -> None:
        self.model_path = "/home/wsy/CFRelighting/sample_scripts/model_logs/" # Need to be specify
    ...
    # Config file
    def get_cfg(self):
        cfg_file_path = glob.glob("/home/wsy/CFRelighting/config/difareli/**", recursive=True)
